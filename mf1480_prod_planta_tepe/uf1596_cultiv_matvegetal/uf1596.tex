...
\label{sec:org4c0ce51}
\subsection{Introducción}
\label{sec:orgcf2b3c0}
...
\label{sec:org586fc72}
\subsubsection{Sustratos}
\label{sec:orgfc09c0c}
...
\label{sec:org0d07d02}
\subsubsection{Características físicas}
\label{sec:org1c876d5}
\begin{itemize}
...
Generalmente esquejes. Podemos encontrar los siguientes \uline{tipos de esquejes}:
\begin{itemize}
...
\subsubsection{Multiplicación por semillas o sexual}
\label{sec:orgb13c0bf}
...
raíces \uline{detienen su crecimiento}. Esto \uline{estimula la creación de raíces 
...
desarrollado de esta manera, \uline{tenderá a seguir una disposición en espiral cuando 
se trasplante.}
...
\item Deshacer \uline{suavemente} el cepellón antes de plantar para facilitar el
enraizamento
