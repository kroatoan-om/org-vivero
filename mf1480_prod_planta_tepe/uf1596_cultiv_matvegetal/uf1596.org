...
- Arenas, gravas  
- Otros materiales de origen sintetico y/o mineral: perlita, vermiculita, lana de roca, arcilla expandida, poliestireno
...
entre el sustrato y la _solución_ nutritiva que alimenta a las plantas a traves
de las raices.
...
Para plantulas de cepellón cónico y piramidal. Se acciona por ruedas compactadoras posteriores. Hay diferentes modelos. En algunps las plantulas las introduce el operario en un sisterma de distribución giratorio. Se puede regular la distancia entre líneas y entre plantas. El rendimieto puede variar entre 3000 y 7000 plantas por línea y por hora
**** trasplante manual
