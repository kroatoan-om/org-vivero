#+TITLE: UF1596. Culivo de material vegetal y cespedes en vivero.
...
#+ATTR_LATEX: :width 0.5\textwidth
[[./img_uf1596/estructura_suelo.jpg]]
#+END_CENTER
...
necesita transplante_: se puede introducir directamente dentro de un a maceta o
...
fácilmete las paredes de la maceta. Esto no pasa con otro tipo de contenedor,
como por ejemplo las macetas de plástico. Al entrar en contacto con el aire las
raices _detienen su crecimiento_. Esto estimula la creación de raices
secundarias que ocupan el volumen de la maceta. Este fenomeno se llama ``poda
aerea radicular'' y resulta muy beneficioso tanto para el productor como el
cliente.\\
**** Barro cocido\\
...
- Existen macetas de _terracota_, que resisten las heladas y permiten respirar a
  las raices al ser más porosas
**** Plástico\\
Son _muy ligeros_ lo que los hace _manejables, duraderos y baratos_. Tienen las
_desventajas_ de que se rajan con facilidad y que dañan las raices cuando se
calientan demasiado. 

En la mayoría de los caoso no cuentan con sistemas _antiespiralizantes_. Esto
puede dificultar el enraizamiento posterior de la planta ya que si la raiz se ha
...
1. *Para seilleros:*
   ...
   - Bandejas de alvéolos: Tienen volumenes comprendidos entre 150 y 350 cm^3 y
     se emplean paraa semillas con porcentajes altos. Se pueden emplear para
     semillas grandes como _bellotas, castañas o cicas_ que se quieren dejar
     todo el primer año y no hay que repicarlas o transplantarlas (arboles para
...
2. *Para el estaquillado:* Encontramos los mismos sistemas que para semillado
   ...
   - Bandejas de alvéolos de pequeño tamaño (75-150cm^3): para el estaquillado
     semileñoso y leñoso. La estaquilla estará hasta que enraice y se
     transplantará a contenedor individual para el engorde
...
3. *Para el engorde:*
   ...
   - Contenedores de papel: Muy usados en plantación de hortalizas, ya que sus
     paredes son atravesadas facilmente por las raices
...
también repicado. El transplante propiamente dicho, sería cuando pasamos las
plantas a un lugar definitivo. Nosotros definiremos el transplante como _el
traslado de la planta de un lugar a otro_.

*** La raiz de la planta.
Cuando producimos planta, tenemos que elegir un sistema de transplante, esto es
a raiz desnuda o en contenedor
...
+ Ventajas:\\
  ...
  - Podemos hacer los semilleros en camas sobre el suelo por lo que _ahorramos
    espacio_  
  - Si el transplante se retrasa las plantas aguantan más a raiz desnuda
+ Inconvenientes:\\
  - El estrés que sufre la planta eb el tranplante es mucho mayor que con
    cepellón. Se rmpen muchas raices al arrancar las plantas del suelo y la
    planta tarda más tiempo en desarrollarse
  - En el semillero a raiz desnuda es difícil conseguir homogeneidad en las plantas
  - Si las _condiciones ambientales_ son desfavorables el día del transplante,
    tendremos una _mayor probabilidad de marras_
  
**** Con cepellón\\
+ Ventajas:\\
  - El transplante con cepellón _reduce el estrés al mínimo_
  - El primer riego _no es tán importante_ ya que las plantas tienen su
...
+ Inconvenientes:\\
  ...
  - Las plantas tienen _un espacio determinado para crecer_ por lo que hay que
    _transplantar_ ya que si no se hace a tiempo las plantas podrían sufrir
    daños 

*** Destino de la planta
Cuando transplantamos planta tenemos dos opciones, transplantar a un contenedor
o transplantar en suelo. 
...
+ Contenedor más _pequeño de lo necesario_:
  - Posible problemas de _desarrollo de las raices_ por falta de espacio. 

**** Destino a suelo:\\
El transplante a suelo se realiza con árboles, hortícolas, arbustos, y en el
ajardinamiento de nuevas zonas o mantenimiento de jardines.

En el caso de las _horticolas_ el transplante está muy mecanizado 
     #+ATTR_LATEX: :width 0.5\textwidth
...
+ _Repartir_ las raices en el hoyo de plantación
+ _Cortar las raices en mal estado_ ya que pueden ser la _entrada de hongos y
  enfermedades_ 
+ _No aplicar_ abonos mineráles ni estiercol en el hoyo de plantación
...
***** Transplante de grandes árboles\\
Para el transplante de grandes árboles que están plantados en suelo se puede
...
raices  
     ...
     #+ATTR_LATEX: :width 0.5\textwidth
     #+CAPTION: Árbol extraido por maquiná especializada
...
***** Robot de transplante bandeja a bandeja

***** Robot de transplante sobre máquina enmacetadora

***** Transplantadora semiautomática

**** transplante manual\\
Se puede realizar como hemos visto con plantas a raiz desnuda o con cepellón. 
