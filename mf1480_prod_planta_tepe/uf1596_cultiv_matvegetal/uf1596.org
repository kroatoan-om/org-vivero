...
#+BEGIN_EXPORT latex
\fbox{\centering El trasplante se realiza cuando la planta ha llenado con raíces todo el
 contenedor} 
#+END_EXPORT

** Aspectos a tener en cuenta del trasplante
Las plantas que hay que trasplantar pueden proceder de:
*** Multiplicación vegetativa

Generalmente esquejes. Podemos encontrar los siguientes _tipos de esquejes_:
...
_humedad y temperatura_. Consideramos que el esqueje está suficientemente desarrollado
...
igual que los esquejes, cuando las raíces se han desarrollado _suficientemente  
por todo el alveolo_ y podemos extraer el cepellón con facilidad. 
...
#+BEGIN_EXPORT latex
\fbox{\parbox{\textwidth}{\textbf{Recuerda:} El trasplante consiste en trasladar de un 
contenedor a otro más grande o al terreno definitivo.}}
#+END_EXPORT
...
Cuando se realiza el endurecimiento _hay que tener muy en cuenta_ las
...
+ *Algunas recomendaciones para el descarte de plantas:*
...
+ *Recomendaciones para la revisión general de plantas:*
...
otras necesidades_ como veremos a continuación.
...
fácilmente las paredes de la maceta. Esto no pasa con otro tipo de contenedor,
como por ejemplo las macetas de plástico. Al entrar en contacto con el aire las
raíces _detienen su crecimiento_. Esto _estimula la creación de raíces 
secundarias_ que ocupan el volumen de la maceta. Este fenómeno se llama ``poda
...
desarrollado de esta manera, _tenderá a seguir una disposición en espiral cuando 
se trasplante._
...
+ Deshacer _suavemente_ el cepellón antes de plantar para facilitar el
  enraizamento 
...
** Materiales auxiliares para operaciones de trasplante

Como  hemos visto los principales materiales para el trasplante son
_sustratos, bandejas, contenedores, trasplantadoras, etc._ Veamos algunos
materiales auxiliares que podemos usar.

**** Hormonas de enraizamiento

Para el tratamiento de esquejes, estaquillas y plantas a raiz desnuda en el
trasplante. Se usan para _favorecer la emisión de raíces_ mejorando asi el
...
el /ácido indolbutírico/ (AIB). Un factor a tener en cuenta para adquirir este
tipo de productos es la _riqueza en materia activa_, pues productos más caros
...
Un ejemplo de aplicación de /AIB/ puede ser humedeciendo la base de los
...
posible que necesitemos de _medios o maquinaria auxiliar_, por ejemplo para
...
trasplantes manuales de árboles o plantas de _gran cepellón_ tenemos como
principal  maquina auxiliar las _barrenadoras_. Las más grandes pueden ir
conectadas a la toma de fuerza del tractor pero tambien las podemos encontrar de
pequeño tamaño.

#+BEGIN_CENTER
#+CAPTION: Ahoyadora de gran tamaño 
#+NAME: fig_ahoyadora
#+ATTR_LATEX: :width 0.5\textwidth
[[./img_uf1596/perf_tractor.jpg]]

#+CAPTION: Motoperforadora 
#+NAME:   fig_motoperforadora 
#+ATTR_LATEX: :width 0.5\textwidth
[[./img_uf1596/motoperforadora.jpg]]
#+END_CENTER
...
*objeto* que en el momento del trasplante el _semillero esté saneado_, limpio y
con la densidad de plantas adecuada.  

*** Aclareo 
Consiste en arrancar plantas cuando han nacido para _disminuir la densidad de 
plantación_. Hay plantaciones que se tienen que hacer con una dosis muy alta de
...
*** Repicado
El repicado es el trasplante inicial de una planta _desde semillero_ a otro
...
El _objetivo principal_ del repicado es _disminuir la competencia_ que existe en
los semilleros. Al repicar aumentamos el espacio entre las plantulas y
_permitimos que el sistema radicular se desarrolle mejor_

** Labores culturales post-trasplante
