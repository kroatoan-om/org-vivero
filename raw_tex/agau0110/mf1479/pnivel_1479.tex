...
\question ¿La porosidad de un suelo es?
  \begin{checkboxes}
    ...
    \choice C. La relación del volumen de espacios vacios de un suelo con
...
\question Cuando un suelo se encuentra bajo condiciones de exceso de agua
  ...
  \end{checkboxes}
  % 10
\question Si de un suel decimos que tiene facilidad para que penetre el agua,
...
\question ¿Qué consecuencias podría tener un suelo en el que hubiera un exceso
  ...
  \begin{checkboxes}
    ...
    \choice D. Un suelo con una optima capacidad de retención de agua
  \end{checkboxes}
  % 13
\question ¿Qué propiedad o característica química se relaciona con el contenido
  ...
  \end{checkboxes}
  % 14
\question ¿Qúe tipo de apero nos permite realizar un labrado vertical?
  \begin{checkboxes}
...
\begin{questions}
  % 1
\question ¿Como se llama el órgano donde se encuentran las celulas femeninas en
  la flor?
  \begin{checkboxes}
    \choice A. Gameto
...
\question ¿La acumulación de sustancias de reserva en una semilla se puede dar
  ...
  \end{checkboxes}
  % 6
\question Las semillas según el contenido de humedad que necesitan retener para
