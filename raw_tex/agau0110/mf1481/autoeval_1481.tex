...
\begin{checkboxes}
  \choice A. Capacidad de germinar y originar plántulas normales en condiciones
  favorables
  \choice B. Capacidad de permanecer funcional después de ser secadas
  ...
  \choice D. La capacidad de producir plántulas con elevadas tasas de crecimiento
\end{checkboxes}
%% 8
...
\end{checkboxes}
%% 9
\question ¿Como se llaman las semillas que pueden ser almacenadas después de
ser desecadas en condiciones óptimas de viabilidad?
\begin{checkboxes}
...
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% C.2 Recolección de frutos y semillas
\titexam{MF 1481. Producción de semillas}
...
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% C3 C4  Recolección de frutos y semillas
\titexam{MF 1481. Producción de semillas}
