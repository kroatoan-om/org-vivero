...
Las semillas son los óvulos maduros de las plantas /angiospermas/ y
...
#+ATTR_LATEX: :width 0.55\textwidth :placement [t!]
...
- Se deja todo en agua para que _la semilla se hunda_ mientras que la pulpa queda en la
  superficie. Esto se conoce como _decantación_. _Las semillas que floten se pueden
  descartar_ ya que, con mucha probabilidad, _no serán viables_.
- Utilizando coladores o mallas retiramos los restos de pulpa o pieles restantes.
- Una vez eliminada la mayor cantidad de pulpa procedemos a limpiar y extraer la semilla.
...
2. *Trillado:* consiste en romper las infrutescencias separando las semillas del
   fruto y de esta manera separar el grano de la paja. Se puede hacer con máquinas
   (trillas), o pisándolo con animales como se hacia tradicionalmente. A escala más
   pequeña también pisando los frutos, bien machacarlos entre dos tableros, bien
   colocándolos en sacos y machacándolos, etc.
...
algunas semillas de maleza comunes_ (/Cuscuta spp/ y /Rumex spp./) que tienen
...
En general las temperaturas bajas prolongan la vida de las semillas.Las
...
Existen mucho modelos de recipiente en el mercado, de manera general:
