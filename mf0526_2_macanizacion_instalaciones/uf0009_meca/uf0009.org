...
- *Registros:* para recoger los datos relativos al _mantenimiento de la
  máquina_, asi como los de los _combustibles, lubricantes, piezas y otros 
...
El mantenmiento debe realizarse _durante toda la vida útil_, no solamente cuando
...
3. Bajo el capó encontraremos la batería unida a dos cables, uno negativo (-) y
   ...
   entre ellos_.
4. Mezclar *bicarbonato sodico* y agua. Aproximadamente _una cucharadita de 
...
de combustible, y _bajas emisiones contaminantes_ (humo negro, oxidos nitrosos,
monóxido de carbono,etc).

Un adecuado protocolo de actuación incluye:

+ Asegurar que el combustible que se suministra está en _condiciones optimas_
...
se debe:
- Utilizar _unicamente_ líquido adecuado. Esto es, liquido /anticongelante/ que
...
- Mantener limpio el radiador. *Precaución* al utilizar _aire comprimido_ para
  la limpieza del radiador pues se pueden dañar las _aletas deflectoreas_
...
A continación damos unas recomendaciones para la comprobación del _nivel de aceite_:
...
- Emplear _unicamente_ el tipo de aceite que recomienda el fabricante
...
** Reconocimiento de los riesgos y peligros más comunes en maquinaria agricola
...
- La parada _debe cortar el suministro de energía_ a los organos de accionamento
- Los organos de accionamiento _deben estar señalizados y ser claramente
  visibles.
...
- Las zonas de corte _deben estár protegidas_
...
Los accidentes por atrapamiento _comienzan_ por el *arrastre de un hilo* u orta
...
Las *lesiones* que se pueden producir por este tipo de accidentes puedn ser
...
- *Toma de fuerza y eje cardánico*
  ...
  + Utilizar _únicamente_ el eje cardánico para la máquina que prevee el
...
#+CAPTION: Vuelco hacia atras (actos inseguros o maniobras incorrectas)
#+ATTR_LATEX: :width \textwidth
