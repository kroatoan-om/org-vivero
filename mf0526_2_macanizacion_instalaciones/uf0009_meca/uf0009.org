...
los motores de tractor es _diésel_.
...
[[./img_0009/partes_motor_basico.jpg]]
#+END_CENTER
...
#+BEGIN:_CENTER
#+CAPTION: Esquema de un sisterma de lubricación
#+ATTR_LATEX: :width 0.65\textwidth
...
- *Refrigeración liquida:* un líquido refrigerante es la encargado de enfriar el
  ...
  + *Termo-metro:* indica la temperatura del líquido refrigerante. Como en el
...
- Sistema de muelles y resortes que acuan sobre los discos haciendo que estos se
  _aciplen y desacoplen_ para transmitir el movimiento del motor a la caja de
  cambios
...
#+BEGIN:_CENTER
#+CAPTION: Parte posterior de un tractor
#+ATTR_LATEX: :width 0.65\textwidth
[[./img_0009/posterior_tractor.png]]

#+CAPTION: Detalle de una barra de toma de fuerza
#+ATTR_LATEX: :width 0.65\textwidth
...
- *Alternador:* es el elemto que permite la recarga y el manteniiento del
  voltaje de la batería.
   #+CAPTION: Partes de un alternador
   #+ATTR_LATEX: :width 0.65\textwidth
