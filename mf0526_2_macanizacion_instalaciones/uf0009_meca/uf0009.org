...
Se denomina *programa de mantenimiento* a una serie de pasos destinados a
_garantizar la vida útil_ de cualquier equipo o maquinaria desde el momento de la
...
pues en el vienen especificadas todas las revisiones que deberán realizarse.
...
es la limpieza del filtro de combustible, ya que si se llena de impurezas puede dañar este elemento}  
#+END_EXPORT
...
- Los órganos de accionamiento deben _estar señalizados y ser claramente 
  visibles._
...
- Por último las *proyecciones* debidas a partículas de madera, tallos, piedras
  ...
  velocidad. Siempre que sea posible las máquinas contarán con carcasas
...
#+CAPTION: Peligro engranajes
#+ATTR_LATEX: :width 0.4\textwidth
[[./img_0009/riesgo_engranaje.png]]
...
#+CAPTION: Señal de ``Peligro corte''
#+ATTR_LATEX: :width 0.6\textwidth
...
#+CAPTION: Señal de ``Peligro atrapamiento''
#+ATTR_LATEX: :width 0.6\textwidth
[[./img_0009/atrapamiento.jpg]]

Las puntas de ejes salientes también pueden enganchar las vestimentas.
...
- *Protector de la toma de fuerza*
  ...
  + Debe utilizarse el escudo protector de la toma de fuerza en los momentos de
...
- A mayor agarre al suelo, mejor estabilidad y menor riesgo de vuelco
